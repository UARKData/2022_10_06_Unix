...
humandate: "Oct. 6, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Guillermo Pupo-Pernet"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<tr> <td>Oct. 6, 2022 9:00-12:00pm</td>  <td><!-- Place the following link anywhere in your page. Make sure the id "s_lc_event_7627923" matches with the above code: jQuery("#s_lc_event_7627923")  //-->
<a id = "s_lc_event_7732968" href="https://uark.libcal.com/calendar/Data/UNIX106">Introduction to Unix Shell </a>
...
<p id="requirements">
  ...
  Due to campus security requirements, please ensure that you are able to have administrative privileges for loading and using the software for our classes.
</p>
